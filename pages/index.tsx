    ...
    <IndexWrapper>
      ...
      <div className="main">
        ...
        <div className="center">
          <a href="https://alfxjx.zhubai.love" title="https://alfxjx.zhubai.love" target={'_blank'} className="umami--click--newsletter-button">
            <Button title="https://alfxjx.zhubai.love" btnType={'primary'} >NewsLetter</Button>
          </a>
          <Link href={'/archive'} >
            <Button className="umami--click--archive-button">Archive</Button>
          </Link>
          <Link href={'/about'}>
            <TextButton className="umami--click--about-button">About</TextButton>
          </Link>
        </div>
...
const Header = () => {
  ...
  return (
    <HeaderWrapper>
      ...
      <Switch initalValue={NowTheme === "L"} onChange={() => themeToggler()} />
    </HeaderWrapper>
  );
};
